...
public class FormatUtils {
    ...
    // Turns a year into a nicely formatted String.
    public static String formatYear(Object obj) {
        if (obj == null) {
            return "";
        }
        try {
            ...
            return "bad date in FormatUtils.formatYear: " + obj.toString() + " error: " + e.getMessage();
        }
    } // formatYear
